...
exports.RoomState = exports.ActionState = exports.InteractableState = exports.NetworkedEntityState = exports.ChatRoomState = exports.ChatQueue = exports.ChatMessage = void 0;
...
], ChatMessage.prototype, "entityId", void 0);
__decorate([
    schema_1.type("string"),
    __metadata("design:type", String)
...
__decorate([
    schema_1.type("string"),
    __metadata("design:type", String)
], NetworkedEntityState.prototype, "entityId", void 0);
__decorate([
    schema_1.type("string"),
    __metadata("design:type", String)
...
class ActionState extends schema_1.Schema {
    constructor() {
        super(...arguments);
        this.entityId = "ID";
        this.actionId = "ID";
...
__decorate([
    schema_1.type("string"),
    __metadata("design:type", String)
], ActionState.prototype, "entityId", void 0);
__decorate([
    schema_1.type("string"),
    __metadata("design:type", String)
], ActionState.prototype, "actionId", void 0);
...
class RoomState extends schema_1.Schema {
    constructor() {
        ...
        this.chatQueue = new schema_1.MapSchema();
        this.action = new schema_1.MapSchema();
        this.serverTime = 0.0;
    }
...
__decorate([
    schema_1.type({ map: ChatQueue }),
    __metadata("design:type", Object)
], RoomState.prototype, "chatQueue", void 0);
__decorate([
    schema_1.type({ map: ActionState }),
    __metadata("design:type", Object)
], RoomState.prototype, "action", void 0);
__decorate([
    schema_1.type("number"),
    __metadata("design:type", Number)
